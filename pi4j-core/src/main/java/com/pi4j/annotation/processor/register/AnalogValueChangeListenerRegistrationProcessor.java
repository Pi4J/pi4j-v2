 ...
 * FILENAME      :  AnalogValueChangeListenerRegistrationProcessor.java
 *
 ...
 * @version $Id: $Id
 */
public class AnalogValueChangeListenerRegistrationProcessor implements RegisterProcessor<AnalogValueChangeListener> {
    ...
    public boolean isEligible(Context context, Object instance, Register annotation, Field field) throws Exception {
        ...
        if(!AnalogValueChangeListener.class.isAssignableFrom(field.getType()))
            return false;
    ...
    /** {@inheritDoc} */
    @Override
    public AnalogValueChangeListener process(Context context, Object instance, Register annotation, Field field) throws Exception {

        AnalogValueChangeListener listener = (AnalogValueChangeListener) field.get(instance);
        if(listener != null) {

 ...
 * FILENAME      :  ShutdownEventProcessor.java
 *
...
/**
 * <p>ShutdownEventProcessor class.</p>
 *
 * @author Robert Savage (<a href="http://www.savagehomeautomation.com">http://www.savagehomeautomation.com</a>)
 * @version $Id: $Id
 */
public class ShutdownEventProcessor implements OnEventProcessor {
    ...
    public void process(Context context, Object instance, OnEvent annotation, Method method) throws Exception {
        ...
        context.addListener((ShutdownListener) event -> {
            try {

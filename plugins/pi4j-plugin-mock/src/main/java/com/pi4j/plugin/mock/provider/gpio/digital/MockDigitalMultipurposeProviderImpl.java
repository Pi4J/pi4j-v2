 ...
 * FILENAME      :  MockDigitalMultipurposeProviderImpl.java
 *
 ...
 * @version $Id: $Id
 */
public class MockDigitalMultipurposeProviderImpl extends DigitalMultipurposeProviderBase implements MockDigitalMultipurposeProvider {

    /**
     * <p>Constructor for MockDigitalOutputProviderImpl.</p>
     */
    public MockDigitalMultipurposeProviderImpl(){
        this.id = ID;
        this.name = NAME;
    }

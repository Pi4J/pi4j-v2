 ...
 * FILENAME      :  DependencyInjectionRegistryTest.java
 *
...
public class DependencyInjectionRegistryTest {
    ...
    public void testDIContextAcquisition() throws Pi4JException {
        ...
        System.out.println("-----------------------------------------------------");
        System.out.println("Pi4J I/O REGISTRY <acquired via dependency injection>");
        System.out.println("-----------------------------------------------------");

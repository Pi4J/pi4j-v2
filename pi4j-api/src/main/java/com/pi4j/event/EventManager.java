...
public class EventManager<SOURCE_TYPE, LISTENER_TYPE extends Listener> {
    private Logger logger = LoggerFactory.getLogger(this.getClass());
    private final SOURCE_TYPE source;
    private final Set<LISTENER_TYPE> listeners = new HashSet<>();

    public EventManager(SOURCE_TYPE source){
        this.source = source;
    }
    ...
    public SOURCE_TYPE dispatch(Event event){
